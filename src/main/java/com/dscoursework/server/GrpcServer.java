...
public class GrpcServer extends Thread {
    ...
    public static void main(String[] args) {
        ((ch.qos.logback.classic.Logger) org.slf4j.LoggerFactory.getLogger(org.slf4j.Logger.ROOT_LOGGER_NAME)).setLevel(Level.INFO);
    ...
    public void run() {
        Server server = ServerBuilder.forPort(port)
                .addService(new GrpcServerService(threadNumber)).build();
